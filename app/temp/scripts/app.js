...
var StickyHeader = function () {
    ...
    _createClass(StickyHeader, [{
        ...
        value: function addSmoothScrolling(links) {
            (0, _jquery2.default)(links).smoothScroll();
        }
    }, {
        ...
        value: function createPageSectionWaypoints(headerLinks) {
            this.pageSections.forEach(function (page) {
                new Waypoint({
                    element: page,
                    handler: function handler(direction) {
                        if (direction == 'down') {
                            var matchingHeaderLink = page.getAttribute('data-matching-link');
                            headerLinks.forEach(function (headerLink) {
                                return headerLink.classList.remove('is-current-link');
                            });
